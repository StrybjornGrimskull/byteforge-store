...
//        return ResponseEntity.status(HttpStatus.OK).body(reviewService.getActiveReviewsByProduct(productOpt.get()));
//    }
//
...
//        return ResponseEntity.status(HttpStatus.OK).body(reviewService.getReviewsByCustomer(customerOpt.get()));
//    }
//
//    @PostMapping
